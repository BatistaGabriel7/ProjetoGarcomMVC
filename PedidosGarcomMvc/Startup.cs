...
namespace PedidosGarcomMvc
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PedidosGarcomMvcContext>(options => 
            options.UseMySql(Configuration.GetConnectionString("PedidosGarcomMvcContext"), builder =>
                builder.MigrationsAssembly("PedidosGarcomMvc")));
