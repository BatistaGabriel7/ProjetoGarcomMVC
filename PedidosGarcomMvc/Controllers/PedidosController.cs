...
namespace PedidosGarcomMvc.Controllers
{
    public class PedidosController : Controller
    {
        ...
        public PedidosController(PedidosGarcomMvcContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Mesa,Solicitante,Prato,Quantidade_Prato,Bebida,Quantidade_Bebida")] Pedido pedido)
        {
            if (id != pedido.Id)
            {
                return NotFound();
